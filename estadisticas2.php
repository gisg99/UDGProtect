...
$mysqli = new mysqli("localhost","id12331242_gisg_99","pW7fWJ(14CSR0wlb","id12331242_udgp");
...
<html>
	...
	<body>
		...
		<header>
			<div class="banner">
				<a href="index.php">
					<img src="https://i.ibb.co/Fs2sm0x/Banner.jpg" height="150px">
				</a>
			</div>
			<nav>
				<ul>
					...
					<li><a href="stadisticas.php">Estadisticas</a></li>
